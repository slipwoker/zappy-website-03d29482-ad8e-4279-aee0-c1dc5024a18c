    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            inputs.forEach(input => {
                ...
                const validator = validators[name] || validators[input.type];
                ...
                if (validator) {
                    ...
                    if (error) {
                        ...
                        formData[name || input.name || input.id] = input.value;
                    }
                }
            });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '03d29482-ad8e-4279-aee0-c1dc5024a18c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '03d29482-ad8e-4279-aee0-c1dc5024a18c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '03d29482-ad8e-4279-aee0-c1dc5024a18c';
